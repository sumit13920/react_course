      ...
      <div>
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/generalhealth" element={<News setProgress={this.setProgress} apiKey={this.apiKey} key="generalhealth" pageSize={this.pageSize} country="us" category="generalhealth" />} />
